import mongoose, { Document, DocumentDefinition, DocumentQuery, FilterQuery, Omit, Query, QueryFindBaseOptions, QueryFindOptions } from 'mongoose';
export interface MongooseModelType<T extends Document, QueryHelpers = {}> extends mongoose.Model<any> {
    ...
    } & Omit<QueryFindBaseOptions, 'lean'>, callback?: (err: any, res: T | null) => void): Query<DocumentDefinition<T>> & QueryHelpers;
    findById(id: any | string | number, projection: any, options: {
        autopopulate: Boolean;
    } & QueryFindBaseOptions, callback?: (err: any, res: T | null) => void): DocumentQuery<T | null, T, QueryHelpers> & QueryHelpers;
    /**
     * Finds documents.
     * @param projection optional fields to return
     */
    ...
    find(conditions: FilterQuery<T>, projection?: any | null, options?: {
        lean: true;
        autopopulate?: Boolean;
    } & Omit<QueryFindOptions, 'lean'>, callback?: (err: any, res: T[]) => void): Query<DocumentDefinition<T>[]> & QueryHelpers;
    find(conditions: FilterQuery<T>, projection?: any | null, options?: {
        autopopulate?: Boolean;
    } & QueryFindOptions, callback?: (err: any, res: T[]) => void): DocumentQuery<T[], T, QueryHelpers> & QueryHelpers;
}
